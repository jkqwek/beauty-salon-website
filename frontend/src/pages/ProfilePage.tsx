      ...
      <div className="bg-rose-50 border-b border-rose-100 py-12 px-6">
        <div className="max-w-5xl mx-auto flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">anna@example.com</p>
          </div>
        </div>
      </div>
                ...
                <div className="bg-white border border-gold/30 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
                  ...
                  <div>
                    <div className="flex items-center gap-2 text-gold font-medium mb-1">
                      <Calendar className="size-4" /> Завтра, 24 окт • 10:00
                    </div>
                    <h3 className="text-xl font-serif text-foreground mb-2">
                      Авторская стрижка
                    </h3>
                    <p className="text-muted-foreground flex items-center gap-2">
                      <User className="size-4" /> Елена Ростова
                    </p>
                  </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  {
                    date: "15 сен 2026",
                    service: "Балаяж и укладка",
                    master: "Елена Ростова",
                    status: "Завершено",
                  },
                  {
                    date: "2 авг 2026",
                    service: "Классический маникюр",
                    master: "Злата Кравцова",
                    status: "Завершено",
                  },
                ].map((visit, i) => (
                  <div
